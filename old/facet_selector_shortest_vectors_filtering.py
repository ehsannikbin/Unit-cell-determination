...
class QtViewer(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        filter_layout.addRow("Grid Tolerance (px)", self.tol_pixels_spin)
        ...
        filter_layout.addRow("Distance Scaling", self.scaling_factor_spin)
        ...
        self.conformity_thresh_spin.setValue(0.80)
        filter_layout.addRow("Min Conformity", self.conformity_thresh_spin)

        self.btn_auto_filter = QtWidgets.QPushButton("Apply Filter to All")
        self.btn_auto_filter.setFocusPolicy(Qt.NoFocus)
        filter_layout.addRow(self.btn_auto_filter)
